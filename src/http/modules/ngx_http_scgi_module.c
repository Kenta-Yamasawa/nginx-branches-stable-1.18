...
/**
 * @brief
 *     scgi モジュールの設定構造体を生成して返す
 * @param[in]
 *     cf: 設定をつかさどる構造体
 * @retval
 *     生成した scgi モジュールの設定構造体
 * @macro
 *     NGX_HTTP_CACHE:
 *         scgi モジュールの設定構造体のキャッシュに配列を生成する
 */
static void *
...
/**
 * @brief
 *     scgi モジュールのロケーション設定構造体を生成して返す
 * @param[in]
 *     cf: 設定をつかさどる構造体
 * @retval
 *     生成した scgi モジュールのロケーション設定構造体
 * @macro
 *     NGX_HTTP_CACHE:
 *         キャッシュ機能を有効化するかどうか
 */
...
/**
 * @brief
 *     scgi モジュールのロケーション設定構造体をマージする
 *     マージ元が無効な場合は既定の初期値で設定する
 * @param[in]
 *     cf: 設定をつかさどる構造体
 *     parent: マージ元
 *     child: マージ先
