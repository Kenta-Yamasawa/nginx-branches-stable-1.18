...
#include <ngx_core.h>
...
#elif (NGX_DARWIN_ATOMIC) /* NGX_HAVE_LIBATOMIC */
...
#elif (NGX_HAVE_GCC_ATOMIC) /* NGX_HAVE_LIBATOMIC */
  ...
  #if ( __i386__ || __i386 || __amd64__ || __amd64 ) // •Â
    #define ngx_cpu_pause()             __asm__ ("pause")
  #else
    #define ngx_cpu_pause()
  #endif /* ( __i386__ || __i386 || __amd64__ || __amd64 ) */


#elif ( __i386__ || __i386 ) /* NGX_HAVE_LIBATOMIC */
